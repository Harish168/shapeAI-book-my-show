...
export default function PaymentModal({ isOpen, setIsOpen, price}) {
  ...
  const launchRazarPay = () => {
      let options ={
          key:"rzp_test_PUs53VPav5dC14",
          amount: price*100,
          currency:"INR",
          name: "Book My Show Clone",
          description: "Movie Purchase or Rental",
          image:"https://i.ibb.co/zPBYW3H/imgbin-bookmyshow-office-android-ticket-png.png",
          handler: () => { //handler function will trigger at the time of payment done or fail
            setIsOpen(false);
            alert("Payment Done");
          },
          theme: { color: "#c4242d" },
              ...
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                      Hello please click the below button to make payment
                  </p>
                </div>
