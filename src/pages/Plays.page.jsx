        ...
        <div className="container mx-auto px-4">
            <div className="w-full lg:flex lg:flex-row-reverse">
              ...
              <div className="lg:w-3/12">
                ...
                <PlaysFilter 
                  title="Date" 
                  tag={["Today","Tomorrow","This week end"]}
                />
                <PlaysFilter 
                  title="Language" 
                  tag={["Tamil","Telengu","English"]}
                />
                <PlaysFilter 
                  title="Categories" 
                  tag={["Theatre"]}
                ...
                <PlaysFilter 
                  title="Genres" 
                  tag={["Drama","Adaption","comedy","Historical","Mythological","Online Streaming Plays"]}
                />
                <PlaysFilter 
                  title="Price" 
                  tag={["Free","0-500","501-2000"]}
                />
              </div>
            </div>
        </div> 
