      ...
      <div className="my-12 container px-4 lg:ml-20 lg:w-2/3">
        <div className="flex flex-col items-start gap-3">
          ...
          <p>
            ...
            after the death of Clark Kent. Meanwhile, Darkseid sends
        ...
        <div className="my-8">
          <h2 className="text-gray-800 font-bold text-2xl mb-3">Application offers</h2>
        ...
        <div className="my-8">
            <h2 className="text-gray-800 font-bold text-2xl mb-4">Cast & Carew</h2>
